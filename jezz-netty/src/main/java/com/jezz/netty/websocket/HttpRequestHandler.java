package com.jezz.netty.websocket;
...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) throws Exception {
        ...
        if (wsUri.equalsIgnoreCase(msg.getUri())) {
            ...
            if (HttpHeaders.is100ContinueExpected(msg)) { //如果HTTP请求头部包含Expect: 100-continue，
                //则响应请求
            ...
            boolean keepAlive = HttpHeaders.isKeepAlive(msg); //如果http请求保持活跃，设置http请求头部信息
            // 并响应请求
            if (keepAlive) {
