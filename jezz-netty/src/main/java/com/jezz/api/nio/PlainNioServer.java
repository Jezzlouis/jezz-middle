...
public class PlainNioServer {
    ...
    public void server(int port) throws Exception {
        ...
        //register ServerSocket to selector and specify that it is interested in new accepted clients serverChannel.register(selector, SelectionKey.OP_ACCEPT);
